...
import { User, CalendarDays, Truck, FileText, ShieldCheck, Camera, StickyNote, Wand2, MapPin, CheckSquare, Square, Home, Gauge } from 'lucide-react'; // Added Home, Gauge
...
export function ReportView({ reportData }: ReportViewProps) {
  const {
    ...
    truckIdNo,
    truckRegNo,
    vehicleOdometer, // Destructure odometer
    workshopLocation, 
    timestamp,
    photos, 
    notes,
    ...
    <Card className="max-w-4xl mx-auto p-4 sm:p-8 shadow-xl print:shadow-none print:border-none">
      ...
      <CardContent className="space-y-6 print:space-y-4">
        ...
        <Section title="Truck Details & Location" icon={Truck}>
          ...
          <DataItem label="Odometer" value={vehicleOdometer ? `${vehicleOdometer} km` : 'N/A'} icon={Gauge} />
